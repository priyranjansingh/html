(function(window, document, $, undefined) {
	...
	if ( $.browser.msie && $.browser.version === "8.0") {
		$(".cd-sticky-nav").clone().prependTo("header").removeClass("noSticky").addClass("is-fixed fadeOut").hide();
	} else {
		$(".cd-sticky-nav").clone().prependTo("header").removeClass("noSticky").addClass("is-fixed fadeOut");
	}
    
	$('.search-result-section').clone().insertAfter($(".is-fixed")).removeClass("noSticky").addClass("hdr3-drop-sticky forSticky");
	$('.browse-categories-container').clone().insertAfter($(".is-fixed")).removeClass("noSticky").addClass("hdr3-drop-sticky forSticky");
	$('.quickorder-detail-container').clone().insertAfter($(".is-fixed")).removeClass("noSticky").addClass("hdr3-drop-sticky forSticky");
	$('.item-detail-container').clone().insertAfter($(".is-fixed")).removeClass("noSticky").addClass("hdr3-drop-sticky forSticky");
	$('.is-fixed .nv3-browse-drop').css("width","110px");
	$('.is-fixed .search-container').addClass('search-container-sticky');
	$('.is-fixed .logo-staples').show();
	$('.is-fixed .browse-text').html("BROWSE");
	$('.is-fixed .search-in').addClass('search-in-sticky');
	$('.is-fixed .search').addClass('search-sticky');
	$('.is-fixed .search-container').addClass('search-container-sticky');
	$('.is-fixed .search-btn').addClass('search-btn-sticky');
	$('.is-fixed .icon-info-browse').css("margin-left","18px");
	$('.is-fixed').find('a.dashboard-link').addClass("forSticky");
	$('.is-fixed').find('a.quickorder-link').addClass("forSticky");
	$('.is-fixed').find('a.browsecat-link').addClass("forSticky");
	$('.is-fixed').find('div.search').addClass("forSticky");
	// Sid Changes Ends
        var slide = false;
        var selCat = "dash";
...
//variable to check if the header3 toggle animation is completed or not
            ...
            function toggleHdr3(element){
                ...
                if(that.hasClass("dashboard-link")){
                    if($(".item-detail-container.noSticky").is(":visible")){
                        $(".item-detail-container.noSticky").slideUp(500,function(){ishdr3Animating = false;});
                    } else {
                        selCat = "dash";
                        $(".nv3-dash-drop").addClass("active");
                        $(".browse-categories-container.noSticky").hide();
                        $(".quickorder-detail-container.noSticky").hide();
                        $(".search-result-section.noSticky").hide();
                        $(".item-detail-container.noSticky").slideDown(500,function(){
                    ...
                    if($(".quickorder-detail-container.noSticky").is(":visible")){
                        $(".quickorder-detail-container.noSticky").slideUp(500,function(){ishdr3Animating = false;});
                    }else {
                        selCat = "quick";
                        $(".nv3-quick-drop").addClass("active");
                        $(".browse-categories-container.noSticky").hide();
                        $(".search-result-section.noSticky").hide();
                        $(".item-detail-container.noSticky").hide();
                        $(".quickorder-detail-container.noSticky").slideDown(500,function(){ishdr3Animating = false;});
                    }
                }
               
                else if(that.hasClass("browsecat-link") ) {
                    if($(".browse-categories-container.noSticky").is(":visible")) {
                        //alert("welcome");
                        
                        $(".browse-categories-container.noSticky").slideUp(500,function(){ishdr3Animating = false;});
                    }
                    else {
                        //alert("welcome1");
                        selCat = "browse";
                        ...
                        $(".bc-Container-2").hide();
                         ...
                         //slider code change here....
                        $(".browse-categories-container.noSticky").slideDown(500,function(){
                    ...
                    if($(".search-result-section.noSticky").is(":visible"))
                        $(".search-result-section.noSticky").slideUp(500,function(){ishdr3Animating = false;});
                    else { 
                        selCat = "search";
                       $(".search-result-section.noSticky").slideDown(500,function(){ishdr3Animating = false;});
                        $(".browse-categories-container.noSticky").hide();
                        $(".item-detail-container.noSticky").hide();
                        $(".quickorder-detail-container.noSticky").hide();  
                    }
			...
			function toggleStickyHdr3(element){
                   
                var that = $(element);
                if(that.hasClass("dashboard-link forSticky")){
                    if($(".item-detail-container.forSticky").is(":visible")){
                        $(".item-detail-container.forSticky").slideUp(500,function(){ishdr3Animating = false;});
                    } else {
                        selCat = "dash";
                        $(".nv3-dash-drop").addClass("active");
                        $(".browse-categories-container.forSticky").hide();
                        $(".quickorder-detail-container.forSticky").hide();
                        $(".search-result-section.forSticky").hide();
                        $(".item-detail-container.forSticky").slideDown(500,function(){
                            ishdr3Animating = false;
							if($('.forSticky .dash-col-right.temp2').find("#list-slider").is(":visible")){
                                $('.lists-slider').tinycarousel({
                                    axis   : "y",
                                    infinite: true, 
                                    display:4
                ...
                else if(that.hasClass("quickorder-link forSticky") ) {
                    if($(".quickorder-detail-container.forSticky").is(":visible")){
                        $(".quickorder-detail-container.forSticky").slideUp(500,function(){ishdr3Animating = false;});
                    }else {
                        selCat = "quick";
                        $(".nv3-quick-drop").addClass("active");
                        $(".browse-categories-container.forSticky").hide();
                        $(".search-result-section.forSticky").hide();
                        $(".item-detail-container.forSticky").hide();
                        $(".quickorder-detail-container.forSticky").slideDown(500,function(){ishdr3Animating = false;});
                    }
                }
               
                else if(that.hasClass("browsecat-link forSticky") ) {
                    if($(".browse-categories-container.forSticky").is(":visible")) {
                        $(".browse-categories-container.forSticky").slideUp(500,function(){ishdr3Animating = false;});
                    }
                    else {
                        selCat = "browse";
                        ...
                        $(".bc-Container-2").hide();
                         ...
                         //slider code change here....
                        $(".browse-categories-container.forSticky").slideDown(500,function(){
			        ...
			        if($(".search-result-section.forSticky").is(":visible"))
                        $(".search-result-section.forSticky").slideUp(500,function(){ishdr3Animating = false;});
                    else { 
                        selCat = "search";
                       $(".search-result-section.forSticky").slideDown(500,function(){ishdr3Animating = false;});
                        $(".browse-categories-container.forSticky").hide();
                        $(".item-detail-container.forSticky").hide();
                        $(".quickorder-detail-container.forSticky").hide();  
                    }
            ...
            function init(){
                ...
                $(document).ready(function(){
                    ...
                    $(".chalk-images").hide();
                    // Sid Changes Starts
                    $('.noSticky .dashboard-link, .noSticky .quickorder-link, .noSticky .browsecat-link, .noSticky .search').click(function(event){
					...
					$('.dashboard-link.forSticky, .quickorder-link.forSticky, .browsecat-link.forSticky, .search.search-sticky.forSticky').click(function(event){
                        event.stopPropagation();
                        if(!ishdr3Animating){
                         selCat = "";       
                         ishdr3Animating = true;
                        $('.nv3-drop').removeClass("active");
                        toggleStickyHdr3(this);
                        }
                    });
					// Sid Changes Ends
            ...
            // To limit the max char of description and for ellipsis property
				...
				// Sid Sticky Header Changes Starts
                //Sticky Header
                $(window).scroll(function(){
                    var stickyHeaderApp = 0;
                    var navPos = 160;
                    if(selCat === "dash"){
                       stickyHeaderApp = $(".shopping-items-container").offset().top;
                    ...
                    if ($(window).scrollTop() > stickyHeaderApp){
            			if ( $.browser.msie && $.browser.version === "8.0") {
							$('.is-fixed').addClass("fadeIn").show();
						} else {
							$('.is-fixed').addClass("fadeIn");
						}
                        ...
                        $(".nv3-browse-drop").removeClass("active");
							...
							if ( $.browser.msie && $.browser.version === "8.0") {
								$('.is-fixed').removeClass("fadeIn").hide();
							} else {
								$('.is-fixed').removeClass("fadeIn");
							}
                    ...
                    if ($(window).scrollTop() >= ($('.hdr-1').height() + $('.hdr-2').height())) {
                        if(($(window).scrollTop() >($('.hdr-1').height() + $('.hdr-2').height())) && ($(window).scrollTop() < $('header').height())) {
                                if(selCat === "dash"){
                                    $('.item-detail-container.noSticky').show(function(){
                                        //slider code change here....
                                        if($('.dash-col-right.temp2').find("#list-slider").is(":visible")){
                                            $('.lists-slider').tinycarousel({
                                                axis   : "y",
                                    ...
                                    $('.quickorder-detail-container.noSticky').show();
                                }else if(selCat === "browse"){
                                    $('.browse-categories-container.noSticky').show();
                                }else if(selCat === "search"){
                                    $('.search-result-section.noSticky').show(); 
                                }
                        }
                    }
                    else {
                        ...
                        if(selCat === "dash"){
                            $(".nv3-dash-drop").addClass("active");
                            $('.item-detail-container.noSticky').show();
                        }else if(selCat === "quick"){
                            $(".nv3-quick-drop").addClass("active");
                            $('.quickorder-detail-container.noSticky').show();
                        }else if(selCat === "browse"){
            ...
            // Sid Sticky Header Changes Ends
			...
			return {
				...
				toggleStickyHdr3: toggleStickyHdr3,
    ...
    $(function (){ 
        if($('.deals-slider').is(':visible')){
            ...
            $(".viewport").jCarouselLite({
                btnNext: ".deals-slider-navigate .deals-slider-right .next",
                btnPrev: ".deals-slider-navigate .deals-slider-left .prev",
                circular: true,
                scroll: 4
            });
        }
