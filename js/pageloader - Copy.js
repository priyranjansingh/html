...
//                    });
                ...
                //Sticky Header Clicks
                if ( $.browser.msie && $.browser.version === "8.0") {
                    $("a.browsecat").click(function(){
                        if($('.browse-container').is(":visible")){
                            $(".nv4-browse-drop").removeClass("active");
                            $('.browse-container').slideUp("slow",function(){
                                $('.browse-container').hide();
                            });
                        } else {
                            $(".nv4-browse-drop").addClass("active");
                            $('.browse-container').slideDown("slow",function(){
                        ...
                        $('.item-container').hide();
                        $('.quickorder-container').hide();
                        $('.search-result').hide();
                    });
                    $("a.quickorder").click(function(){
                        if($('.quickorder-container').is(":visible")){
                            $(".nv4-quick-drop").removeClass("active");
                            $('.quickorder-container').slideUp("slow",function(){
                                $('.quickorder-container').hide();
                            });
                        } else {
                            $(".nv4-quick-drop").addClass("active");
                            $('.quickorder-container').slideDown("slow",function(){
                                $('.quickorder-container').show();
                            });
                        }
                        $(".nv4-browse-drop").removeClass("active");
                        $(".nv4-dash-drop").removeClass("active");
                    ...
                    $("a.dashboard").click(function(){
                        if($('.item-container').is(":visible")){
                            $(".nv4-dash-drop").removeClass("active");
                            $('.item-container').slideUp("slow",function(){
                                $('.item-container').hide();
                            });   
                        } else {
                            $(".nv4-dash-drop").addClass("active");
                            $('.item-container').slideDown("slow",function(){
                                $('.item-container').show();
                            });
                        }
                        $(".nv4-browse-drop").removeClass("active");
                        ...
                        $('.browse-container').hide();
                        $('.search-result').hide();
                        $('.quickorder-container').addClass('zIndex');
                        $('.browse-container').addClass('zIndex');
                        $('.search-result').addClass('zIndex');
                    });
                    $(".search-in-sticky").focus(function(){
                       if($('.search-result').is(":visible")){
                        ...
                        $('.quickorder-container').hide("fadeIn");
                        $('.browse-container').hide("fadeIn");
                        $('.item-container').hide("fadeIn");
                        $('.quickorder-container').addClass('zIndex');
                        $('.browse-container').addClass('zIndex');
                        $('.item-container').addClass('zIndex');
                    });
                } else {
                    $("a.browsecat").click(function(){
                        if($('.browse-container').hasClass("fadeIn")){
                            $(".nv4-browse-drop").removeClass("active");
                            $('.browse-container').removeClass("fadeIn");
                            $('.browse-container').addClass("zIndex");
                        } else {
                            $('.browse-container').removeClass("zIndex");
                            $(".nv4-browse-drop").addClass("active");
                            $('.browse-container').addClass("fadeIn");
                        }
                        $(".nv4-dash-drop").removeClass("active");
                        $(".nv4-quick-drop").removeClass("active");
                    ...
                    $("a.quickorder").click(function(){
                        if($('.quickorder-container').hasClass("fadeIn")){
                            ...
                            $('.quickorder-container').removeClass("zIndex");
                            $(".nv4-quick-drop").addClass("active");
                    ...
                    $("a.dashboard").click(function(){
                        if($('.item-container').hasClass("fadeIn")){
                            ...
                            $('.item-container').removeClass("zIndex");
                            $(".nv4-dash-drop").addClass("active");
                    ...
                    $(".search-in-sticky").focus(function(){
                       if($('.search-result').hasClass("fadeIn")){
                            ...
                            $('.search-result').removeClass("zIndex");
                ...
                $(window).scroll(function(){
                    ...
                    if ( $.browser.msie && $.browser.version === "8.0") {
                        if ($(window).scrollTop() > stickyHeaderApp){
                            ...
                            $("#dropholder").removeClass("sendDown zIndex");
                            // $("#dropholder").addClass("sendDown");
                        } else if($(window).scrollTop() <= stickyHeaderApp){
                                $("#dropholder").addClass("sendDown zIndex");
                    ...
                    if ($(window).scrollTop() >= ($('.hdr-1').height() + $('.hdr-2').height())) {
                        ...
                        if(($(window).scrollTop() >($('.hdr-1').height() + $('.hdr-2').height())) && ($(window).scrollTop() < $('header').height())) {
                                ...
                                if(selCat === "dash"){
                                    $('.item-detail-container').show(function(){
                                        //slider code change here....
                                        if($('.dash-col-right.temp2').find("#list-slider").is(":visible")){
                                            $('.lists-slider').tinycarousel({
                                                axis   : "y",
